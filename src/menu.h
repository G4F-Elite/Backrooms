...
inline void drawSurvivalTime(float t) {
    ...
    drawText(b,0.75f,0.9f,1.8f,0.6f,0.55f,0.35f,0.7f);
    glDisable(GL_BLEND); glEnable(GL_DEPTH_TEST);
}
...
inline void drawHealthBar(float hp) {
    ...
    drawText("HP:",-0.95f,-0.85f,1.5f,r,g,0.2f,0.8f); drawText(b,-0.82f,-0.85f,1.5f,r,g,0.2f,0.7f);
    glDisable(GL_BLEND); glEnable(GL_DEPTH_TEST);
}
...
inline void drawSanityBar(float sn) {
    ...
    drawText("SN:",-0.95f,-0.92f,1.5f,0.4f*p,0.3f*p,0.7f*p,0.8f); drawText(b,-0.82f,-0.92f,1.5f,0.4f*p,0.3f*p,0.7f*p,0.7f);
    glDisable(GL_BLEND); glEnable(GL_DEPTH_TEST);
}
...
inline void drawStaminaBar(float st) {
    ...
    drawText("ST:",-0.95f,-0.78f,1.5f,0.3f,0.6f*yc,0.3f,0.8f); drawText(b,-0.82f,-0.78f,1.5f,0.3f,0.6f*yc,0.3f,0.7f);
    glDisable(GL_BLEND); glEnable(GL_DEPTH_TEST);
}
...
inline void drawFlashlightBattery(float battery, bool isOn) {
    ...
    drawText("FL:",0.55f,-0.92f,1.5f,r,g,0.3f,0.8f); drawText(b,0.68f,-0.92f,1.5f,r,g,0.3f,0.7f);
    glDisable(GL_BLEND); glEnable(GL_DEPTH_TEST);
}
...
inline void drawNoteCounter(int count) {
    ...
    drawText(b,-0.95f,0.9f,1.5f,0.6f,0.55f,0.35f,0.7f);
    glDisable(GL_BLEND); glEnable(GL_DEPTH_TEST);
}
...
inline void drawPhaseIndicator(int phase) {
    ...
    if(phase>=0&&phase<4) drawText(pn[phase],0.55f,0.82f,1.2f,0.5f,0.45f,0.3f,0.5f);
    glDisable(GL_BLEND); glEnable(GL_DEPTH_TEST);
}
